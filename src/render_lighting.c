                           ...
                           LightingSystem* lighting)
{
    ...
    float normal_len =
        sqrtf(surface_normal.x * surface_normal.x + surface_normal.y * surface_normal.y +
    ...
    for (uint32_t i = 0; i < lighting->light_count; i++)
    {
        ...
        else if (light->type == LIGHT_TYPE_POINT)
        {
            ...
            float distance = sqrtf(light_dir.x * light_dir.x + light_dir.y * light_dir.y +
        ...
        float dot_product = -(surface_normal.x * light_dir.x + surface_normal.y * light_dir.y +
