...
# Source files
SOURCES = core.c systems.c assets.c asset_loader/asset_loader_index.c asset_loader/asset_loader_mesh.c asset_loader/asset_loader_material.c render_3d.c render_camera.c render_lighting.c render_mesh.c ui.c data.c graphics_api.c gpu_resources.c main.c
...
ENGINE_SRC_FOR_TEST = src/assets.c src/asset_loader/asset_loader_index.c src/asset_loader/asset_loader_mesh.c src/asset_loader/asset_loader_material.c src/render_mesh.c src/gpu_resources.c
